...
def process_presentation():
    ...
    local_temp_path = os.path.abspath("temp_presentation_v18.pptx")
    ...
    out_path = os.path.abspath(r"G:\マイドライブ\codex-skills\tbiiro-renewal\更新資料\epice_エピス_TG提案書_v18.pptx")
