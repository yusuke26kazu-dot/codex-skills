...
def process_presentation():
    ...
    local_temp_path = os.path.abspath("temp_presentation_v14.pptx")
    ...
    for idx in range(pres.Slides.Count, 0, -1):
        ...
        # Ultimate failproof rule: delete slides containing "素材" or "印刷しない" (CP932/Shift_JIS safe check)
    ...
    out_path = os.path.abspath(r"G:\マイドライブ\codex-skills\tbiiro-renewal\更新資料\epice_エピス_TG提案書_v14.pptx")
