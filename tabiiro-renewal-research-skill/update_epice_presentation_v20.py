...
def process_presentation():
    ...
    local_temp_path = os.path.abspath("temp_presentation_v20.pptx")
    ...
    # Template slide 2: TextBox 9 = "スーパーテーマ特集", Picture 17 = placeholder image
    # TextBox 10 = "本テーマ特集にて御社をご紹介しています" (do NOT replace this)
    ...
    # 3. Process Regular Theme slides (Slide 3)
    # Template slide 3: TextBox 6 = "テーマ特集" (NOT スーパーテーマ特集), Picture 19 = placeholder image
    # TextBox 10 = "本テーマ特集にて御社をご紹介しています" (do NOT replace this)
    # IMPORTANT: exclude slides that also contain U_SUPER_THEME (スーパーテーマ特集)
    ...
    # 4. Process SEO article slides (Slide 4)
    # Template slide 4: TextBox 9 = "SEO記事", TextBox 11 = keyword, TextBox 12 = views
    # Picture 18 = placeholder image
    ...
    out_path = os.path.abspath(r"G:\マイドライブ\codex-skills\tbiiro-renewal\更新資料\epice_エピス_TG提案書_v20.pptx")
