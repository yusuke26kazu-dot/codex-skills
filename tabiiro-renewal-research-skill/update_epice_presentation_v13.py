...
U_SEO_KW_PLACEHOLDER = "\u3007\u3007\u3007 \u3007\u3007\u3007" # 〇〇〇 〇〇〇 (U+3007 Ideographic Number Zero)
...
def find_gray_rectangle_group(shapes):
    for shape in shapes:
        if shape.Type == 6: # msoGroup
            ...
            text = shape.TextFrame.TextRange.Text
            if "\u753b\u50cf\u3092\u30b3\u30d4\u30da\u3057\u3066\u304f\u3060\u3055\u3044" in text: # 画像をコピペしてください
                return shape
    return None
...
def process_presentation():
    ...
    super_themes_data = [
        ("\u9ad8\u7d1a\u5e97\u30fb\u9ad8\u7d1a\u30ec\u30b9\u30c8\u30e9\u30f3", "https://tabiiro.jp/gourmet/theme/high-class-restaurant/ranking/kinki/kyoto/", "1\u4f4d", "high-class-restaurant"), # 高級店・高級レストラン, 1位
        ("\u30ca\u30c3\u30c8\u53ef\u30fb\u30ca\u30c3\u30c8\u540c\u4f34", "https://tabiiro.jp/gourmet/theme/pet_restaurant/ranking/kinki/kyoto/", "1\u4f4d", "pet_restaurant") # ペット可・ペット同伴, 1位 (Note: \u30ca\u30c3\u30c8 is a placeholder style for representation but let's write exactly)
    ]
    # Re-verify pet string: ペット可・ペット同伴 -> \u30da\u30c3\u30c8\u53ef\u30fb\u30da\u30c3\u30c8\u540c\u4f34
    super_themes_data = [
        ("\u9ad8\u7d1a\u5e97\u30fb\u9ad8\u7d1a\u30ec\u30b9\u30c8\u30e9\u30f3", "https://tabiiro.jp/gourmet/theme/high-class-restaurant/ranking/kinki/kyoto/", "1\u4f4d", "high-class-restaurant"), # 高級店・高級レストラン, 1位
        ("\u30da\u30c3\u30c8\u53ef\u30fb\u30da\u30c3\u30c8\u540c\u4f34", "https://tabiiro.jp/gourmet/theme/pet_restaurant/ranking/kinki/kyoto/", "1\u4f4d", "pet_restaurant") # ペット可・ペット同伴, 1位
    ]
    
    # Regular Theme list (Slide 6 Target)
    normal_themes_data = [
        ("\u30d5\u30ec\u30f3\u30c1", "https://tabiiro.jp/gourmet/theme/french/ranking/kinki/kyoto/", "2\u4f4d", "french"), # フレンチ, 2位
        ("\u53e4\u6c11\u5bb6\u30ab\u30d5\u30a7\u30fb\u53e4\u6c11\u5bb6\u30ec\u30b9\u30c8\u30e9\u30f3", "https://tabiiro.jp/gourmet/theme/kominka-cafe/ranking/kinki/kyoto/", "4\u4f4d", "kominka-cafe"), # 古民家カフェ・古民家レストラン, 4位
        ("\u30af\u30ea\u30b9\u30de\u30b9\u30b0\u30eb\u30e1\u30fb\u30af\u30ea\u30b9\u30de\u30b9\u30c7\u30a3\u30ca\u30fc", "https://tabiiro.jp/gourmet/theme/xmas_gourmet/ranking/kinki/kyoto/", "4\u4f4d", "xmas_gourmet") # クリスマスグルメ・クリスマスディナー, 4位
    ]
    ...
    genre_rankings_data = [
        ("\u9ad8\u7d1a\u5e97", "https://tabiiro.jp/gourmet/theme/high-class-restaurant/ranking/kinki/kyoto/", "1\u4f4d", 20, 0), # 高級店, 1位
        ("\u53e4\u6c11\u5bb6", "https://tabiiro.jp/gourmet/theme/kominka-cafe/ranking/kinki/kyoto/", "4\u4f4d", 11, 1), # 古民家, 4位
        ("\u30af\u30ea\u30b9\u30de\u30b9", "https://tabiiro.jp/gourmet/theme/xmas_gourmet/ranking/kinki/kyoto/", "4\u4f4d", 20, 2)  # クリスマス, 4位
    ]
    
    seo_articles = [
        ("\u4eac\u90fd \u30e9\u30f3\u30c1 \u304a\u3057\u3083\u308c", "https://tabiiro.jp/gourmet/article/kyoto-lunch-oshare/", "1\u4f4d", "8,389"), # 京都 ランチ おしゃれ, 1位
        ("\u9285\u95a3\u5bfa \u5468\u8fba \u30b0\u30eb\u30e1", "https://tabiiro.jp/gourmet/article/ginkakuji-shuhen-gourmet/", "6\u4f4d", "1,308"), # 銀閣寺 周辺 グルメ, 6位
        ("GW \u4eac\u90fd \u7a74\u5834 \u30b0\u30eb\u30e1", "https://tabiiro.jp/gourmet/article/kyotoshinai-GW-anaba/", "1\u4f4d", "284") # GW 京都 穴場 グルメ, 1位
    ]
    ...
    shop_id = "315399"
    prefecture = "\u4eac\u90fd\u5e9c" # 京都府
    address = "\u4eac\u90fd\u5e9c\u4eac\u90fd\u5e95\u4e0a\u4eac\u533a\u5efa\u753a\u901a\u4eca\u51fa\u5ddd\u4e0b\u30eb\u771f\u5982\u5802\u524d\u753a105" # 京都府京都市上京区寺町通今出川下ル真如堂前町105
    ...
    local_temp_path = os.path.abspath("temp_presentation_v13.pptx")
    ...
    # Dynamic search strictly using Unicode Escaped string to completely prevent CP932 matching failures
    super_theme_base_idx = find_slide_index_by_text(pres, U_SUPER_THEME, exclude_text=U_SKIP_INDICATOR)
    ...
    theme_base_idx = find_slide_index_by_text(pres, U_THEME, exclude_text=U_SKIP_INDICATOR)
    if theme_base_idx != -1:
    ...
    seo_base_idx = find_slide_index_by_text(pres, U_SEO_INDICATOR, exclude_text=U_SKIP_INDICATOR)
    if seo_base_idx != -1:
    ...
    for idx in range(pres.Slides.Count, 0, -1):
        ...
        # Use BOTH unicode escaped forms and partial checks to guarantee matching on Windows
        if U_SKIP_INDICATOR in text_content or "\u203b" in text_content or "\u5370\u5237\u3057\u306a\u3044" in text_content:
            slide.Delete()
    ...
    if views_slide_idx != -1:
        ...
        with sync_playwright() as p:
            ...
            try:
                ...
                page.locator("button", has_text=U_VIEWS_SLIDE_INDICATOR[:2]).click() # 計算する
                page.wait_for_timeout(2000)
        ...
        headers = ["\u6708", "10\u6708", "11\u6708", "12\u6708", "1\u6708", "2\u6708", "3\u6708", "4\u6708", "\u5408\u8a08", "\u5e73\u5747"] # 月, 10月... 合計, 平均
    ...
    out_path = os.path.abspath(r"G:\マイドライブ\codex-skills\tbiiro-renewal\更新資料\epice_\u30a8\u30d4\u30b9_TG\u63d0\u6848\u66f8_v13.pptx") # epice_エピス_TG提案書_v13.pptx
    out_path = os.path.abspath(r"G:\マイドライブ\codex-skills\tbiiro-renewal\更新資料\epice_エピス_TG提案書_v13.pptx")
